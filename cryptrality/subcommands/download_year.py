...
from cryptrality.misc import DefaultHelpParser, xopen
...
def add_parser(subparsers: _SubParsersAction, module_name: str) -> DefaultHelpParser:
    return subparsers.add_parser(
        module_name, add_help=False, help=("Download yearly historical data")
    )
...
def download_year(subparsers, module_name, argv):
    ...
    parser.add_argument(dest="symbol", help="Symbol to download, eg ETHUSDT")
    parser.add_argument(
        "-k",
        "--kline",
        dest="k",
